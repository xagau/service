...
public class CopperFeed extends GenericFeed {

    public CopperFeed() {
        setInstrument(new Instrument("CU"));
    ...
    public double getPrice(double units) {
        ...
        try {
            String u = "https://www.quandl.com/api/v3/datasets/LME/PR_CU.json?api_key=peiLDAJgvfvs-SAs5F-K&start_date=2018-05-25&end_date=2018-05-25";
            URL url = new URL(u);
    ...
    public static void main(String[] args ){
        CopperFeed feed = new CopperFeed();
